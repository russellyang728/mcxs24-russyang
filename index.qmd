...
Compare to the Gibbs Sampler of the Stochastic Volatility model of baseline model, the parameters of extension model appear to fluctuate within a wider range. The variance in $Σ_{21}$ in the second set also exhibits larger spikes.

...
Posterior_pram = Posterior_parameters(X=X,Y=Y,A=Prior$A.prior,V=Prior$V.prior,
...
A.bar  <- Posterior_pram$A.bar
V.bar  <- Posterior_pram$V.bar
S.bar  <- Posterior_pram$S.bar
nu.bar <- Posterior_pram$nu.bar

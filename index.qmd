...
Two functions code are added representing the derived posterior.
...
The time series plot is posterior draws mean of $\sigma^2$ at each time spot in extension model. The plot shows same volatility as baseline model.
...
Compare the Gibbs Sampler of the Stochastic Volatility model of extension model, the parameters appear to fluctuate within a wider range compared to the baseline one. The variance in $Σ_{22}$ in the second set also exhibits larger spikes than in the basic.
...
plot(Posterior.sv.ext$A.posterior[2,1,],type='l',col="#660099",ylab="",xlab="",main=expression(A[21]), lwd = 0.1)
plot(Posterior.sv.ext$A.posterior[3,2,],type='l',col="#CC66CC",ylab="",xlab="",main=expression(A[32]), lwd = 0.1)
plot(Posterior.sv.ext$Sigma.posterior[1,1,],type='l',col="#6699CC",ylab="",xlab="",main=expression(Sigma[21]), lwd = 0.1)
plot(Posterior.sv.ext$Sigma.posterior[2,2,],type='l',col="#0066CC",ylab="",xlab="",main=expression(Sigma[22]), lwd = 0.1)

...
combined_plot <- unemp_p + govspend_p + taxrev_p + infl_p +
...
par(mfrow = c(2, 2))
acf(unemp,  plot = TRUE, main = "ACF for Unemplyment Rate")
acf(govspend, plot = TRUE , main = "ACF for Government Spending")
acf(taxrev, plot = TRUE , main = "ACF for Tax Revenue")
acf(infl, plot = TRUE , main = "ACF for Inflation")
...
#| 
par(mfrow = c(2, 2))
pacf(unemp,  plot = TRUE, main = "PACF for Unemplyment Rate")
pacf(govspend, plot = TRUE , main = "PACF for Government Spending")
pacf(taxrev, plot = TRUE , main = "PACF for Tax Revenue")
pacf(infl, plot = TRUE , main = "PACF for Inflation")
...
From time series plots, we have several hypothesis:

...
From the impulse response plots, we can conclude there are significant effect on unemployment rate and government spending, but no effect for others.
...
Here are the impulse responses for extension model. Compared with baseline model, the effect on unemployment rate turns to insignificant.
